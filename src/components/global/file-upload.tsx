...
if(value) {
  ...
  <div className='flex flex-col justify-center items-center'>
    ...
    <div className='relative flex items0center p-2 mt-2 rounded-md bg-black bg-background/10'>
      <FileIcon />
      <a href={value} target='_blank'
      rel="noopener_noreferrer"
      className='ml-2 text-sm text-indigo-500
      dark:text-indigo-400 hover:underline'> View PDF </a>
    </div>
 )}
